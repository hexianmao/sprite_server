...
import com.alibaba.sprite.statistic.HeartbeatRecorder;
...
public class Heartbeat {
    ...
    private final HeartbeatConnectionFactory factory;
    private final HeartbeatRecorder recorder;
    private final ReentrantLock lock;
    private final int maxRetryCount;
    private int errorCount;
    private volatile int status;
    private HeartbeatConnection detector;
    ...
    public Heartbeat(Node node) {
        ...
        this.factory = new HeartbeatConnectionFactory();
    ...
    public HeartbeatConnection getDetector() {
        return detector;
    }
    ...
    public long getTimeout() {
        HeartbeatConnection detector = this.detector;
        if (detector == null) {
            return -1L;
        }
     ...
     * 设定结果
     */
    public void setResult(int result, HeartbeatConnection detector, boolean isTransferError, byte[] message) {
        switch (result) {
        case OK_STATUS:
            setOk(detector);
    ...
    private void setOk(HeartbeatConnection detector) {
    ...
    private void setOff(HeartbeatConnection detector) {
    ...
    private void setError(HeartbeatConnection detector) {
    ...
    private void setTimeout(HeartbeatConnection detector) {
