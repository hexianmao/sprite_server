...
import static com.alibaba.sprite.route.RouteResultsetNode.DEFAULT_REPLICA_INDEX;
...
import com.alibaba.sprite.exception.UnknownDataNodeException;
...
public final class MultiNodeExecutor extends NodeExecutor {
    ...
    public void execute(RouteResultsetNode[] nodes, final boolean autocommit, final BlockingSession ss, final int flag) {
        ...
        ThreadPoolExecutor exec = Sprite.getInstance().getServerExecutor();
