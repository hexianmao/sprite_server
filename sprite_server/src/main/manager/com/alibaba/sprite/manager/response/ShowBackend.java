...
import com.alibaba.sprite.heartbeat.HeartbeatConnection;
...
public class ShowBackend {
    ...
    public static void execute(ManagerConnection c) {
        ...
        for (NIOProcessor p : Sprite.getInstance().getProcessors()) {
    ...
    private static RowDataPacket getRow(BackendConnection c, String charset) {
        ...
        if (c instanceof HeartbeatConnection) {
            HeartbeatConnection detector = (HeartbeatConnection) c;
            Heartbeat heartbeat = detector.getHeartbeat();
