...
import com.alibaba.sprite.config.util.ConfigUtil;
...
public class ClusterConfig {
    ...
    private static Map<String, NodeConfig> loadNode(Element root, int port) {
        Map<String, NodeConfig> nodes = new HashMap<String, NodeConfig>();
        ...
        for (int i = 0, n = list.getLength(); i < n; i++) {
            ...
            if (node instanceof Element) {
                ...
                NodeConfig conf = new NodeConfig(name, host, port, weight);
                nodes.put(name, conf);
                hostSet.add(host);
            }
        }
    ...
    private static Map<String, List<String>> loadGroup(Element root, Map<String, NodeConfig> nodes) {
