...
import com.alibaba.sprite.net.packet.ExecutePacket;
import com.alibaba.sprite.net.util.ByteUtil;
import com.alibaba.sprite.net.util.PreparedStatement;
import com.alibaba.sprite.server.ServerConnection;
import com.alibaba.sprite.server.response.PreparedStmtResponse;

/**
 * @author xianmao.hexm 2012-8-28
 */
public class ServerPrepareHandler implements PrepareHandler {
