 ...
 * (created at 2011-6-1)
 */
package com.alibaba.sprite.parser.visitor;

import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_FALSE;
import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_FALSE;
import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_NULL;
import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_TRUE;
import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_UNKNOWN;
import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_NULL;
import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_TRUE;
import static com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression.IS_UNKNOWN;

import java.util.List;
import java.util.Map;

import com.alibaba.sprite.parser.ast.ASTNode;
import com.alibaba.sprite.parser.ast.expression.BinaryOperatorExpression;
import com.alibaba.sprite.parser.ast.expression.Expression;
import com.alibaba.sprite.parser.ast.expression.PolyadicOperatorExpression;
import com.alibaba.sprite.parser.ast.expression.TernaryOperatorExpression;
import com.alibaba.sprite.parser.ast.expression.UnaryOperatorExpression;
import com.alibaba.sprite.parser.ast.expression.comparison.BetweenAndExpression;
import com.alibaba.sprite.parser.ast.expression.comparison.ComparisionEqualsExpression;
import com.alibaba.sprite.parser.ast.expression.comparison.ComparisionIsExpression;
import com.alibaba.sprite.parser.ast.expression.comparison.ComparisionNullSafeEqualsExpression;
import com.alibaba.sprite.parser.ast.expression.comparison.InExpression;
import com.alibaba.sprite.parser.ast.expression.logical.LogicalAndExpression;
import com.alibaba.sprite.parser.ast.expression.logical.LogicalOrExpression;
import com.alibaba.sprite.parser.ast.expression.misc.InExpressionList;
import com.alibaba.sprite.parser.ast.expression.misc.QueryExpression;
import com.alibaba.sprite.parser.ast.expression.misc.UserExpression;
import com.alibaba.sprite.parser.ast.expression.primary.CaseWhenOperatorExpression;
import com.alibaba.sprite.parser.ast.expression.primary.DefaultValue;
import com.alibaba.sprite.parser.ast.expression.primary.ExistsPrimary;
import com.alibaba.sprite.parser.ast.expression.primary.Identifier;
import com.alibaba.sprite.parser.ast.expression.primary.MatchExpression;
import com.alibaba.sprite.parser.ast.expression.primary.ParamMarker;
import com.alibaba.sprite.parser.ast.expression.primary.PlaceHolder;
import com.alibaba.sprite.parser.ast.expression.primary.RowExpression;
import com.alibaba.sprite.parser.ast.expression.primary.SysVarPrimary;
import com.alibaba.sprite.parser.ast.expression.primary.UsrDefVarPrimary;
import com.alibaba.sprite.parser.ast.expression.primary.VariableExpression;
import com.alibaba.sprite.parser.ast.expression.primary.function.FunctionExpression;
import com.alibaba.sprite.parser.ast.expression.primary.function.cast.Cast;
import com.alibaba.sprite.parser.ast.expression.primary.function.cast.Convert;
import com.alibaba.sprite.parser.ast.expression.primary.function.datetime.Extract;
import com.alibaba.sprite.parser.ast.expression.primary.function.datetime.GetFormat;
import com.alibaba.sprite.parser.ast.expression.primary.function.datetime.Timestampadd;
import com.alibaba.sprite.parser.ast.expression.primary.function.datetime.Timestampdiff;
import com.alibaba.sprite.parser.ast.expression.primary.function.groupby.Avg;
import com.alibaba.sprite.parser.ast.expression.primary.function.groupby.Count;
import com.alibaba.sprite.parser.ast.expression.primary.function.groupby.GroupConcat;
import com.alibaba.sprite.parser.ast.expression.primary.function.groupby.Max;
import com.alibaba.sprite.parser.ast.expression.primary.function.groupby.Min;
import com.alibaba.sprite.parser.ast.expression.primary.function.groupby.Sum;
import com.alibaba.sprite.parser.ast.expression.primary.function.string.Char;
import com.alibaba.sprite.parser.ast.expression.primary.function.string.Trim;
import com.alibaba.sprite.parser.ast.expression.primary.literal.IntervalPrimary;
import com.alibaba.sprite.parser.ast.expression.primary.literal.LiteralBitField;
import com.alibaba.sprite.parser.ast.expression.primary.literal.LiteralBoolean;
import com.alibaba.sprite.parser.ast.expression.primary.literal.LiteralHexadecimal;
import com.alibaba.sprite.parser.ast.expression.primary.literal.LiteralNull;
import com.alibaba.sprite.parser.ast.expression.primary.literal.LiteralNumber;
import com.alibaba.sprite.parser.ast.expression.primary.literal.LiteralString;
import com.alibaba.sprite.parser.ast.expression.string.LikeExpression;
import com.alibaba.sprite.parser.ast.expression.type.CollateExpression;
import com.alibaba.sprite.parser.ast.fragment.GroupBy;
import com.alibaba.sprite.parser.ast.fragment.Limit;
import com.alibaba.sprite.parser.ast.fragment.OrderBy;
import com.alibaba.sprite.parser.ast.fragment.SortOrder;
import com.alibaba.sprite.parser.ast.fragment.VariableScope;
import com.alibaba.sprite.parser.ast.fragment.ddl.ColumnDefinition;
import com.alibaba.sprite.parser.ast.fragment.ddl.TableOptions;
import com.alibaba.sprite.parser.ast.fragment.ddl.datatype.DataType;
import com.alibaba.sprite.parser.ast.fragment.ddl.index.IndexColumnName;
import com.alibaba.sprite.parser.ast.fragment.ddl.index.IndexOption;
import com.alibaba.sprite.parser.ast.fragment.tableref.Dual;
import com.alibaba.sprite.parser.ast.fragment.tableref.IndexHint;
import com.alibaba.sprite.parser.ast.fragment.tableref.InnerJoin;
import com.alibaba.sprite.parser.ast.fragment.tableref.NaturalJoin;
import com.alibaba.sprite.parser.ast.fragment.tableref.OuterJoin;
import com.alibaba.sprite.parser.ast.fragment.tableref.StraightJoin;
import com.alibaba.sprite.parser.ast.fragment.tableref.SubqueryFactor;
import com.alibaba.sprite.parser.ast.fragment.tableref.TableRefFactor;
import com.alibaba.sprite.parser.ast.fragment.tableref.TableReference;
import com.alibaba.sprite.parser.ast.fragment.tableref.TableReferences;
import com.alibaba.sprite.parser.ast.stmt.dal.DALSetCharacterSetStatement;
import com.alibaba.sprite.parser.ast.stmt.dal.DALSetNamesStatement;
import com.alibaba.sprite.parser.ast.stmt.dal.DALSetStatement;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowAuthors;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowBinLogEvent;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowBinaryLog;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowCharaterSet;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowCollation;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowColumns;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowContributors;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowCreate;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowDatabases;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowEngine;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowEngines;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowErrors;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowEvents;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowFunctionCode;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowFunctionStatus;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowGrants;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowIndex;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowMasterStatus;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowOpenTables;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowPlugins;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowPrivileges;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowProcedureCode;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowProcedureStatus;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowProcesslist;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowProfile;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowProfiles;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowSlaveHosts;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowSlaveStatus;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowStatus;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowTableStatus;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowTables;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowTriggers;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowVariables;
import com.alibaba.sprite.parser.ast.stmt.dal.ShowWarnings;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLAlterTableStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLCreateIndexStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLCreateTableStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLDropIndexStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLDropTableStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLRenameTableStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLTruncateStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DescTableStatement;
import com.alibaba.sprite.parser.ast.stmt.ddl.DDLAlterTableStatement.AlterSpecification;
import com.alibaba.sprite.parser.ast.stmt.dml.DMLCallStatement;
import com.alibaba.sprite.parser.ast.stmt.dml.DMLDeleteStatement;
import com.alibaba.sprite.parser.ast.stmt.dml.DMLInsertStatement;
import com.alibaba.sprite.parser.ast.stmt.dml.DMLReplaceStatement;
import com.alibaba.sprite.parser.ast.stmt.dml.DMLSelectStatement;
import com.alibaba.sprite.parser.ast.stmt.dml.DMLSelectUnionStatement;
import com.alibaba.sprite.parser.ast.stmt.dml.DMLUpdateStatement;
import com.alibaba.sprite.parser.ast.stmt.extension.ExtDDLCreatePolicy;
import com.alibaba.sprite.parser.ast.stmt.extension.ExtDDLDropPolicy;
import com.alibaba.sprite.parser.ast.stmt.mts.MTSReleaseStatement;
import com.alibaba.sprite.parser.ast.stmt.mts.MTSRollbackStatement;
import com.alibaba.sprite.parser.ast.stmt.mts.MTSSavepointStatement;
import com.alibaba.sprite.parser.ast.stmt.mts.MTSSetTransactionStatement;
