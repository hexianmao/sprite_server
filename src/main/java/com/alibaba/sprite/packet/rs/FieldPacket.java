 ...
 */
package com.alibaba.sprite.packet.rs;

import java.nio.ByteBuffer;

import com.alibaba.sprite.net.Connection;
import com.alibaba.sprite.packet.AbstractPacket;
import com.alibaba.sprite.util.BufferUtil;
...
public class FieldPacket extends AbstractPacket {
    ...
    private void readBody(Message mm) {
