...
import com.alibaba.sprite.server.ServerAuthHandler;
 ...
 * @author xianmao.hexm
 */
public final class ManagerAuthHandler implements Handler {
    ...
    public ManagerAuthHandler(ManagerConnection source) {
        this.source = source;
    }
